...
export default function TermsOfService() {
  return (
    <>
      <PageMeta title="Terms of Service | MultySMM" description="Read the Terms of Service for MultySMM platform." canonicalPath="/terms" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Terms of Service", path: "/terms" }]} />
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <div className="p-4 rounded-xl bg-red-500/8 border border-red-500/15 space-y-2">
                ...
                <p>By making a payment to MultySMM, you explicitly agree that:</p>
                <ul className="list-disc pl-6 space-y-1">
            ...
            <section className="space-y-3">
              ...
              <p>By using MultySMM, you acknowledge and agree that:</p>
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>MultySMM is not responsible for any action taken by social media platforms against your account as a result of your use of our services</li>
                <li>You will not hold MultySMM liable for any legal consequences arising from your use of our services</li>
            ...
            <section className="space-y-3">
              ...
              <p>All content, features, and functionality of the Platform—including but not limited to text, graphics, logos, icons, software, and algorithms—are the exclusive property of MultySMM and are protected by international copyright, trademark, and other intellectual property laws.</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">13. Limitation of Liability</h2>
              <p>To the maximum extent permitted by law, MultySMM shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section className="space-y-3">
              ...
              <p>You agree to indemnify, defend, and hold harmless MultySMM and its officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, and expenses arising from:</p>
              <ul className="list-disc pl-6 space-y-1">
