...
export default function RefundPolicy() {
  return (
    <>
      <PageMeta title="Refund Policy | MultySMM" description="Understand MultySMM's refund and cancellation policies." canonicalPath="/refund" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Refund Policy", path: "/refund" }]} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>Funds added to your MultySMM wallet are considered <strong className="text-foreground">service credits</strong> and are generally non-refundable. Refunds for wallet deposits may be considered only under:</p>
              <ul className="list-disc pl-6 space-y-1">
