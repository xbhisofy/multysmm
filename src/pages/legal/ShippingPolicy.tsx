        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>For any delivery related queries, contact us at <a className="text-blue-500 hover:underline" href="mailto:support@multysmm.com">support@multysmm.com</a> or Telegram <a className="text-blue-500 hover:underline" href="https://t.me/multysmm" target="_blank" rel="noreferrer">@multysmm</a>.</p>
            </section>
          </div>
        </div>
      </div>
