...
-- IMPORTANT: This project ref is bcowzxvrjcyqwdkufoeu.
-- Replace [YOUR_SERVICE_ROLE_KEY] with the current service role key before running manually.
...
-- 4. Schedule Order Status Check (Every 2 minutes)
